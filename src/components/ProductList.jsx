                        ...
                        {[1, 2, 3].map((item) => (
                            ...
                            >
                                <div className="flex flex-col max-w-full items-center justify-center gap-2">
                                    <img src={product} alt="" className='group-hover:scale-105 transition-all duration-300 ease-in-out'/>
                                    <p className="text-md text-white/80 uppercase">
                                        coffee: <span className="text-yellow-400 text-xl">★★★★★</span>
                                    </p>
                                    <h3 className="text-xl font-semibold text-white uppercase">Coffee Beans</h3>
                                    <p className="text-md font-semibold text-white uppercase">Price: $20.00</p>
                                </div>
                            </div>
                        ))}
                    </div>
